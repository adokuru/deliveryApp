...
<header class="page-header" data-background="images/slide01.jpg">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          <div class="logo-item"> <img src="images/logo01.jpg" alt="Image"> </div>
          <!-- end logo-item --> 
        </div>
        <!-- col-3 -->
        <div class="col-lg-3 col-6">
          <div class="logo-item"> <img src="images/logo02.jpg" alt="Image"> </div>
          <!-- end logo-item --> 
        </div>
        <!-- col-3 -->
        <div class="col-lg-3 col-6">
          <div class="logo-item"> <img src="images/logo03.jpg" alt="Image"> </div>
          <!-- end logo-item --> 
        </div>
        <!-- col-3 -->
        <div class="col-lg-3 col-6">
          <div class="logo-item"> <img src="images/logo04.jpg" alt="Image"> </div>
          <!-- end logo-item --> 
        </div>
        <!-- col-3 --> 
      </div>
  ...
  <section class="content-section no-spacing">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="gallery-item"> <a href="images/gallery-item01.jpg" data-fancybox><img src="images/gallery-item01.jpg" alt="Image"></a> </div>
          <!-- end gallery-item --> 
        </div>
        <!-- col-6 -->
        <div class="col-md-6">
          <div class="row inner">
            <div class="col-md-6">
              <div class="gallery-item"> <a href="images/gallery-item02.jpg" data-fancybox><img src="images/gallery-item02.jpg" alt="Image"></a> </div>
              <!-- end gallery-item --> 
            </div>
            <!-- col-6 -->
            <div class="col-md-6">
              <div class="gallery-item"> <a href="images/gallery-item03.jpg" data-fancybox><img src="images/gallery-item03.jpg" alt="Image"></a> </div>
              <!-- end gallery-item --> 
            </div>
            <!-- col-6 -->
            <div class="col-md-6">q
              <div class="gallery-item"> <a href="images/gallery-item04.jpg" data-fancybox><img src="images/gallery-item04.jpg" alt="Image"></a> </div>
              <!-- end gallery-item --> 
            </div>
            <!-- col-6 -->
            <div class="col-md-6">
              <div class="gallery-item"> <a href="images/gallery-item05.jpg" data-fancybox><img src="images/gallery-item05.jpg" alt="Image"></a> </div>
              <!-- end gallery-item --> 
            </div>
            <!-- col-6 --> 
          </div>
