      ...
      <div class="row align-items-center">
        <div class="col-lg-7">
          <div class="side-content">
            ...
            <a href="#" class="custom-button">Discover All Solutions</a> </div>
          <!-- end side-content --> 
        </div>
        <!-- end col-7 -->
        <div class="col-lg-5">
          ...
          <div class="icon-box">
            <div class="inner">
              ...
              <p>Experts who have extensive, 
                ...
                chain management</p>
              <a href="#" class="custom-link">Connect with an Expert</a> </div>
            <!-- end inner --> 
          </div>
          <!-- end icon-box --> 
        </div>
          ...
          <div class="solution-box">
            <figure><img src="{{ asset('images/solution-image01.jpg')}}" alt="Image">
              <figcaption> <small>Solutions</small>
                <h6>Food & Beverage</h6>
                <a href="#">Discover More</a> </figcaption>
            </figure>
          </div>
          <!-- end solution-box --> 
        </div>
      ...
      <div class="row align-items-center no-gutters">
        <div class="col-lg-6">
          <div class="side-services">
            ...
            <a href="#" class="custom-link">View All Services</a> </div>
          <!-- end side-services --> 
        </div>
        <!-- end col-6 -->
        <div class="col-lg-6">
          <figure class="side-image full-right">
            ...
            <!-- end info-box --> 
            <img src="{{ asset('images/side-image02.jpg')}}" alt="Image"> </figure>
        </div>
        <!-- end col-6 --> 
      </div>
      <!-- end row --> 
      ...
      <div class="row">
        <div class="col-12">
          <div class="cta-bar">
            ...
            <a href="#" class="custom-button">Get A Quote</a> <a href="#" class="light-button">Estimate cost</a> </div>
          <!-- end cta-bar --> 
        </div>
        <!-- end col-12 --> 
      </div>
              ...
              <div class="swiper-slide">
                <div class="testimonial">
                  <p>As a first time importer from the Far 
                    ...
                    the process.</p>
                  <h6>Jack Abraham</h6>
                  <small>Director of Envato LLC</small> </div>
                <!-- end testimonial --> 
              </div>
              <!-- end swiper-slide --> 
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="recent-news">
            <figure><img src="{{ asset('images/recent-news01.jpg')}}" alt="Image"> <a href="#"><i class="lni lni-chevron-right"></i></a> </figure>
            <div class="content">
              ...
              <span><i class="lni lni-comments-alt"></i> 0 Comments</span> </div>
            <!-- end content --> 
          </div>
          <!-- end recent-news --> 
        </div>
        ...
        <div class="col-md-6">
          <div class="recent-news">
            <figure><img src="{{ asset('images/recent-news02.jpg')}}" alt="Image"> <a href="#"><i class="lni lni-chevron-right"></i></a></figure>
            <div class="content">
