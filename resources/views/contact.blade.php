...
<header class="page-header" data-background="images/slide01.jpg">
        ...
        <div class="col-12">
          <div class="section-title">
            ...
            <h2>We’d love to hear from you</h2>
              <p>Please send your enquiry to <u>sales@fdhsl.co.uk</u>, or contact your local<br> 
  specialists using the contact details below.</p>
        ...
        <!-- end col-12 -->
          ...
          Email: <a href="#">shipping@fdhsl.co.uk</a>
                  </address>
  ...
  Phone: +44 (0)1482 325781<br>
  Email: <a href="#">shipping@fdhsl.co.uk</a>
                  </address><a href="https://www.google.com/maps/search/?api=1&amp;query=centurylink+field" data-fancybox="" data-width="640" data-height="360" class="custom-button">FIND US ON MAP</a>
              </div>
              <!-- end contact-box -->
          </div>
          <!-- end col-5 -->
